<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="LinkBrowser.aspx.vb" Inherits="DeveloperJI.LinkBrowser" %>
...
<body>
    ...
    <div>
        ...
        <table width="100%" cellpadding="10" cellspacing="0" border="1" style="background-color: #DFDFDF;">
            <tr>
                <td valign="top">
                    Folders:<br />
