<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ImageBrowser.aspx.vb" Inherits="DeveloperJI.ImageBrowser" %>
...
<body>
	...
	<div>
		...
		<table width="720px" cellpadding="10" cellspacing="0" border="1" style="margin:15px;">
			<tr>
				<td style="width: 396px; background-color: #DFDFDF;" valign="middle" align="center">
					<asp:Image ID="Image1" runat="server" Style="max-height: 450px; max-width: 380px;" />
				</td>
				<td style="width: 324px; background-color: #F2F2F2;" valign="top">
					Folders:<br />
