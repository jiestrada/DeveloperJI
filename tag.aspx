<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Principal.Master" CodeBehind="tag.aspx.vb" Inherits="DeveloperJI.tag" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContenBody" runat="server">
    ...
    <div style="margin-top:30px;">
            ...
            <ItemTemplate>
                <div class="blogTwoCols">
                    ...
                    <div class="blogPie">
                        ...
                        <div class="categoria">
                            <a href="<%# FriendlyUrl.Href("~/Categoria", Eval("CategoriaPrincipal"), Controlador.SqlGenerico.GetCategorias(DeveloperJI.db.coneccion.getDataBase, Eval("CategoriaPrincipal")))%>">
        ...
        <asp:LinqDataSource ID="LinqPost" runat="server" ContextTypeName="DeveloperJI.DBClassDataContext" EntityTypeName="" OrderBy="PostDateModificado desc" TableName="vPostMetas" Where="MetaKey == @MetaKey" Select="new (PostID, PostDateModificado, PostContent, PostTitle, PostImage, CategoriaPrincipal, Clave, PostCommentCount)">
            <WhereParameters>
                <asp:SessionParameter Name="MetaKey" SessionField="Meta" Type="String" />
            </WhereParameters>
        </asp:LinqDataSource>
